    ...
    return BlocBuilder<HistoryCheckDetailsBloc, HistoryCheckDetailsState>(
      builder: (context, state) {
        ...
        if (state is HistoryCheckDetailsLoadedState) {
          DateTime _createAt = DateTime.parse(state
              .checkDetailsModel.checkDetailsDataModel.createdAt
              .replaceAll("+0300", "+0000"));
          return SingleChildScrollView(
            padding: EdgeInsets.symmetric(
                horizontal: widthRatio(size: 16, context: context),
                vertical: widthRatio(size: 23, context: context)),
            child: Column(
              ...
              children: [
                ...
                RichText(
                  text: TextSpan(
                    children: <TextSpan>[
                      TextSpan(
                        text:
                            state.checkDetailsModel.checkDetailsDataModel.total,
                        style: appLabelTextStyle(
                            fontSize: heightRatio(size: 18, context: context),
                            color: Colors.black),
                      ),
                ...
                //Charge bonuses
                if (state.checkDetailsModel.checkDetailsDataModel
                            .bonusToCharge !=
                        null &&
                    state.checkDetailsModel.checkDetailsDataModel
                            .bonusToCharge !=
                        0)
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      ...
                      Text(
                          "${state.checkDetailsModel.checkDetailsDataModel.bonusToCharge} бонусов",
                          style: appTextStyle(
                              fontSize: heightRatio(size: 18, context: context),
                ...
                //Paid bonuses
                if (state.checkDetailsModel.checkDetailsDataModel.paidBonus !=
                        null &&
                    state.checkDetailsModel.checkDetailsDataModel.paidBonus !=
                        0)
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      ...
                      SizedBox(height: heightRatio(size: 3, context: context)),
                      Text(
                          "-${state.checkDetailsModel.checkDetailsDataModel.paidBonus} бонусов",
                          style: appTextStyle(
                              fontSize: heightRatio(size: 18, context: context),
                              fontWeight: FontWeight.w400,
                              color: Colors.black)),
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) => InkWell(
                    onTap: () {
                      if (state.checkDetailsProductsModel.data[index]
                              .assortmentUuid !=
                          null) {
                        Navigator.push(
                          context,
                          CupertinoPageRoute(
                            builder: (context) => RedesProductDetailsPage(
                              productUuid: state.checkDetailsProductsModel
                                  .data[index].assortmentUuid,
                            ),
                          ),
                        );
                      } else {
                        Fluttertoast.showToast(
                            msg: "productNotRecognizedText".tr());
                      }
                    },
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                        ...
                        Stack(
                          children: [
                            Card(
                              ...
                              color: colorBlack03,
                              child: state.checkDetailsProductsModel.data[index]
                                      .assortmentImages.isNotEmpty
                                  ? CachedNetworkImage(
                                      imageUrl: state
                            ...
                            if (state.checkDetailsProductsModel.data[index]
                                        .totalBonus !=
                                    null &&
                                state.checkDetailsProductsModel.data[index]
                                        .totalBonus !=
                                    0)
                              Positioned(
                                ...
                                child: Container(
                                  ...
                                  child: Row(children: [
                                    ...
                                    Text(
                                      state.checkDetailsProductsModel
                                          .data[index].totalBonus!
                              ...
                              Row(
                                children: [
                                  Expanded(
                                    child: InkWell(
                                      onTap: () {
                                        if (state.checkDetailsProductsModel
                                                .data[index].assortmentUuid !=
                                            null) {
                                          openSendMarkForProductBottomSheet(
                                              ...
                                              comment: state
                                                      ...
                                                      .ratingComment ??
                                                  '',
                                              checkUuid: state.checkDetailsModel
                                                  .checkDetailsDataModel.uuid,
                                              checkLineUuid: state
                                                  .checkDetailsProductsModel
                                                  .data[index]
                                                  .uuid);
                                            ...
                                            ? Container(
                                                ...
                                                decoration: BoxDecoration(
                                                  color: state
                                                      ...
                                                      ? colorBlack03
                                                      : Color(int.parse(
                                                          "0xff${state.checkDetailsProductsModel.data[index].discountTypeColor}")),
                                                  borderRadius:
                                                  ...
                                                  text: TextSpan(
                                                    children: <TextSpan>[
                                                      TextSpan(
                                                        ...
                                                        style:
                                                            appLabelTextStyle(
                                                          color: (state.checkDetailsProductsModel.data[index].originalPrice !=
                                                                          null ||
                                                                      state.checkDetailsProductsModel.data[index].price !=
                                                                          null) &&
                                                                  state
                                                                          .checkDetailsProductsModel
                                                                          .data[
                                                      ...
                                                      child: Text(
                                                          state
                                                              ...
                                                              ? state
                                                                          ...
                                                                          .price !=
                                                                      null
                                                                  ? state.checkDetailsProductsModel.data[index].originalPrice !=
                                                                          null
                                                                      ? state
                                                                              .checkDetailsProductsModel
                                                                              .data[index]
