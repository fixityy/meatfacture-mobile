      ...
      return InkWell(
          onTap: () {
            Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => RedesSecondaryPage(
                      upText: "historyOfPointsText".tr(),
                      contentWidget: Container(
                          color: screenBackgrountGreyColor,
                          child: RedesHasBonusesContent())),
                ));
          },
          child: Container(
              ...
              children: [
                          ...
                          Container(
                            ...
                            child: Container(
                              ...
                              child: SvgPicture.asset(
                                  'assets/images/bonuses_main_icon.svg',
                                  width: widthRatio(size: 50, context: context),
                                  height:
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                state is ProfileLoadedState &&
                                        state.profileModel.data!.bonusBalance !=
                                            0
                                    ? Text(
                                        state.profileModel.data!.bonusBalance
                                            .toString(),
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      state is ProfileLoadedState &&
                              state.profileModel.data!.bonusBalance != null &&
                              state.profileModel.data!.bonusBalance != 0
                          ? "FindOutHowToSaveMoreText".tr()
                          : "collectHowToStartCopyingText".tr(),
                      style: appTextStyle(
