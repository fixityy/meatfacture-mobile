  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        SizedBox(height: heightRatio(size: 20, context: context)),
        Text("we_added_handy_features_and_fixed_bugs".tr(),
            style: appTextStyle(
        ...
        InkWell(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              borderRadius:
                  BorderRadius.circular(widthRatio(size: 12, context: context)),
              color: mainColor,
            ),
            child: Text("to_update_app".tr(),
                style: appTextStyle(
        ...
        SizedBox(height: heightRatio(size: 16, context: context)),
        Center(
          child: Text("we_will_redirect_you_to_the_app_store".tr(),
