...
class RedesAssortmentsCard2Widget extends StatefulWidget {
  ...
  @override
  State<RedesAssortmentsCard2Widget> createState() =>
      _RedesAssortmentsCard2WidgetState();
}

class _RedesAssortmentsCard2WidgetState
    extends State<RedesAssortmentsCard2Widget> {
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color:
                                (widget.assortmentsListModel.hasYellowPrice !=
                                            null) &&
                                ...
                                TextSpan(
                                  ...
                                  text: widget.assortmentsListModel
                                      ...
                                      ? widget.assortmentsListModel
                                          ...
                                          .toString()
                                      : widget
                                          .assortmentsListModel.currentPrice,
                                ),
                                TextSpan(
