...
class LoyaltyCardViewBottomSheetWidget extends StatelessWidget {
  ...
  const LoyaltyCardViewBottomSheetWidget({
            ...
            Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                    image: AssetImage('assets/images/newLoyaltyCardBG.png'),
                    fit: BoxFit.cover),
                color: Colors.white,
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    child: InkWell(
                        ...
                        child: ClipRRect(
                          ...
                          child: Container(
                            child: QrImage(
                                data: loyaltyCardsListModel.data[0].number,
                                size: heightRatio(size: 110, context: context),
                  ...
                  Column(
                    ...
                    children: [
                      SvgPicture.asset("assets/images/newMFIcon.svg",
                          width: widthRatio(size: 63, context: context),
