...
class OrderListWidget extends StatelessWidget {
          ...
          return Expanded(
            child: PaginationView<OrderListDataModel>(
                ...
                onError: (dynamic error) =>
                    Center(child: Text('errorText'.tr())),
                onEmpty: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () => BlocProvider.of<SecondaryPageBloc>(context)
                            .add(CatalogEvent()),
                        child: Container(
                          alignment: Alignment.center,
                ...
                pageFetch: (currentListSize) async {
                  OrderListModel orderListModel =
                      await OrderProvider().getOrderListResponse(i);
                  i += 1;
                  return orderListModel.data;
                },
                itemBuilder: (BuildContext context,
                    OrderListDataModel orderListDataModel, int index) {
                  DateTime date = DateTime.parse(orderListDataModel
                  ...
                  return Column(
                    ...
                    //               .fillBasketFromORderResponse(
                    //                   orderListDataModel.uuid)) {
                    //             _basketListBloc.add(BasketLoadEvent());
                    //             _secondaryPageBloc.add(BasketPageLoadEvent());
                    //             orderListDataModel.orderDeliveryTypeId ==
                    //                     "delivery"
                    //                 ? _orderTypeBloc
                    //                     .add(OrderTypeDeliveryEvent())
                    //                 : _orderTypeBloc
                    //                     .add(OrderTypePickupEvent());
                    //           }
                    //         },
                    //         closeOnTap: true,
                    ...
                    //               border:
                    //                   Border.all(color: newRedDark, width: 1)),
                    //         ),
                    //       ),
                    //     ],
                    ...
                    //                         orderId: orderListDataModel.uuid));
                    //                 Navigator.push(
                    //                     context,
                    //                     MaterialPageRoute(
                    //                         builder: (context) =>
  ...
  String getOrderStatus({required OrderListDataModel orderListDataModel}) {
  ...
  void initSlidableAnimation({required BuildContext context}) async {
    if (await prefs.getBool("hasOrderListIn") == null ||
        await prefs.getBool("hasOrderListIn") == false) {
