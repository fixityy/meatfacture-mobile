...
class ProductInShopPage extends StatelessWidget {
  ...
  final TextEditingController shopsSearchTextController =
      TextEditingController();

  ProductInShopPage({
    required this.storesListModel,
  ...
  Widget build(BuildContext context) {
    ...
    void _searchTextChange(String searchText) {
      ...
      _productInShopBloc.add(ProductInShopAsListEvent(
          storesListModel: searchedStoresListModel,
          assortmentUnitId: assortmentUnitId));
                    ...
                    Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            //Search Field
                            SizedBox(
                                height: heightRatio(size: 7, context: context)),
                            Container(
