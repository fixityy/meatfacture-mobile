...
class _AppTextFieldState extends State<AppTextField> {
  ...
  Widget build(context) {
    return TextFormField(
      ...
      validator: (value) {
        return widget.validator != null && value != null
      ...
      decoration: InputDecoration(
        ...
        hintStyle: appLabelTextStyle(
            color: newGrey, fontSize: heightRatio(size: 14, context: context)),
        // errorText: widget.errorText.isNotEmpty ? widget.errorText : null,
        errorStyle: appLabelTextStyle(
        ...
        border: UnderlineInputBorder(
            borderSide: BorderSide(color: widget.borderColor)),
        contentPadding:
            EdgeInsets.only(top: heightRatio(size: 10, context: context)),
      ),
    );
  }
}
