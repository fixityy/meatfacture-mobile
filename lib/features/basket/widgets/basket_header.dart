  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          SizedBox(
              height: heightRatio(size: isPayment ? 17 : 10, context: context)),
          Row(
            children: [
              Expanded(
                child: Row(
                        ...
                        ? Row(
                            ...
                            children: [
                              ...
                              InkWell(
                                ...
                                child: Container(
                                    width:
                                        widthRatio(size: 36, context: context),
                                    height:
                                        heightRatio(size: 36, context: context),
                                    padding: EdgeInsets.all(
                                        widthRatio(size: 9, context: context)),
                                    decoration: BoxDecoration(
