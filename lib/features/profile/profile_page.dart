...
class ProfilePage extends StatefulWidget {
  ...
  const ProfilePage({super.key, this.profileNavKey});
  ...
  static logout({
    required AuthPageBloc regBloc,
    required BasicPageBloc basicPageBloc,
  }) async {
...
class _ProfilePageState extends State<ProfilePage> {
  late ProfileModel profileModelFirst;
  late ProfileModel profileModelSecond;
  ...
  late AddressesClientBloc _clientAddressBloc;
  Timer? _debounce;
  ...
  Widget build(BuildContext context) {
    ...
    SmartContactsBloc _smartContactsBloc =
        BlocProvider.of<SmartContactsBloc>(context);
    late String bDateText;
      ...
      builder: (context, state) {
        if (state is ProfileLoadedState) {
          ...
          phoneTextController.text =
              state.profileModel.data!.phone!.replaceFirst("+7", "");
        }
                                            ...
                                            InkWell(
                                              onTap: () {
                                                AppAlert.show(
                                                  context: context,
                                                  message:
                                                      'К сожалению, нельзя изменить номер телефона учетной записи, ',
                                                  messageTap:
                                                  ...
                                                  funcPushToContactsWidgetOnTap:
                                                      () {
                                                    _smartContactsBloc.add(
                                                        SmartContactsLoadEvent());
                                                    Navigator.push(
                                                      context,
                                                      MaterialPageRoute(
                                                        builder: (context) =>
                                                ...
                                                : InkWell(
                                                    onTap: () {
                                                      AppAlert.show(
                                                        context: context,
                                                        message:
                                                            'К сожалению, нельзя изменить дату рождения, ',
                                                        messageTap:
                                                            'обратитесь в поддержку',
                                                        sec: 3,
                                                ...
                                                if (state.profileModel.data!
                                                  ...
                                                  prefs =
                                                      await SharedPreferences
                                                          .getInstance();
                                                  String number = await prefs
                                                      .getString(SharedKeys
                                                          .callCenterNumber)!;
