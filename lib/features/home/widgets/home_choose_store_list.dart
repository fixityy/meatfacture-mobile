                    ...
                    onTap: () async {
                      ...
                      showModalBottomSheet<dynamic>(
                        ...
                        builder: (BuildContext bc) =>
                            Wrap(children: [HomeChooseStoreMapDetails()]),
                      ).then((value) =>
                        ...
                        title: Row(
                          ...
                          children: [
                            widget.shopsList[index].image != null
                                ? SizedBox(
                                    height:
                                        heightRatio(size: 40, context: context),
                                    width:
                                        widthRatio(size: 50, context: context),
                                    child: Image.network(
                                        widget.shopsList[index].image!.path,
                                        fit: BoxFit.cover),
                                  )
                                : SizedBox.shrink(),
                            SizedBox(
                                width: widthRatio(size: 7, context: context)),
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  widget.shopsList[index].workHoursFrom ==
                                              null ||
                                          widget.shopsList[index]
                                                  .workHoursTill ==
                                              null
                                      ? ""
                                      : widget.shopsList[index].workHoursFrom! +
