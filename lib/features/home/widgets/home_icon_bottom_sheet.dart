...
class HomeIconBottomSheet extends StatelessWidget {
        ...
        if (infoText != null) {
          return Container(
            ...
            child: ConstrainedBox(
              constraints:
                  BoxConstraints(maxHeight: screenHeight(context) * 0.8),
  ...
  Widget backBottom({required BuildContext context}) {
    return InkWell(
      onTap: () {
      ...
      child: Container(
        margin:
            EdgeInsets.only(bottom: heightRatio(size: 20, context: context)),
        alignment: Alignment.center,
