        ...
        child: Stack(
          ...
          children: [
            Container(
              ...
              padding:
                  EdgeInsets.only(top: heightRatio(size: 6, context: context)),
                        ...
                        BlocConsumer<FavoriteProductBloc, FavoriteProductState>(
                          listener: (context, state) {
                            if (state is FavoriteProductOldTokenState) {
                              ProfilePage.logout(
                                  regBloc: _authPageBloc,
                                  basicPageBloc: _basicPageBloc);
                            }
                          },
                          builder: (context, state) {
                            if (state is FavoriteProductLoadingState) {
                              return Container(
                                height:
                                    heightRatio(size: 290, context: context),
                                child: Center(
                            ...
                            if (state is FavoriteProductLoadedState) {
                              if (state.favoriteProductModel.data.isNotEmpty) {
                                ...
                                if (state.favoriteProductVariantUuidModel.data
                                    .isEmpty) {
                                  if (state.favoriteProductTitleModel!.data
                                      .isNotEmpty) {
                                ...
                                return Column(
                                  children: [
                                    ...
                                    if (state.favoriteProductVariantUuidModel
                                        .data.isNotEmpty)
                                      Padding(
                                        padding: EdgeInsets.symmetric(
                                            horizontal: widthRatio(
                                      ...
                                      Container(
                                        ...
                                        alignment: Alignment.center,
                                        height: heightRatio(
                                            size: 57, context: context),
                                        margin: EdgeInsets.symmetric(
                                            horizontal: 16),
                                        child: RichText(
                                          text: TextSpan(
                                            text: "leftToBuyOnText".tr() +
                                                ": ${(900 - double.parse(state.purchasesSumModel!)).toStringAsFixed(0)} ",
                                            style: appLabelTextStyle(
                                                fontSize: heightRatio(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SvgPicture.asset(
                                  ...
                                  height:
                                      heightRatio(size: 56, context: context),
