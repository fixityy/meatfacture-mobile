...
class _RecipeDetailScreenState extends State<RecipeDetailScreen> {
  ...
  void onTapFavoriteButton() async {
    ...
    if (isAuth != "guest") {
      ...
      var _likeResponse = await AddOrDeleteReceiptsToFavoriteProvider(
      ...
      if (_likeResponse == "old token") {
        ...
        BlocProvider.of<BasicPageBloc>(context)?.add(ProfilePage.logout(
            regBloc: authPageBloc, basicPageBloc: BlocProvider.of(context)));
      }
    } else {
                        ...
                        ? Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                  fit: BoxFit.cover,
                                  image: NetworkImage(widget.recipe.filePath!)),
                            ),
                      ...
                      children: [
                        ...
                        InkWell(
                          ...
                          child: Container(
                            ...
                            child: SvgPicture.asset(
                              isActive
                                  ? 'assets/images/newHeartRactive.svg'
                                  : 'assets/images/newHeartR.svg',
                    ...
                    if (widget.recipe.assortments.length > 0)
                      GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return RecipeProductCard(
                              assortmentsListModel:
                                  widget.recipe.assortments[index],
