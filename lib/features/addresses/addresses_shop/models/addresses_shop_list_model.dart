...
class AddressesShopListModel {
  ...
  MetaModel meta;
  AddressesShopListModel({
    required this.data,
    required this.meta,
  });

  factory AddressesShopListModel.fromJson(Map<String, dynamic> json) =>
      AddressesShopListModel(
        data: List<AddressesShopModel>.from(
            json["data"].map((x) => AddressesShopModel.fromJson(x))),
