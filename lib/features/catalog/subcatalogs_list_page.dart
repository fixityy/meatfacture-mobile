...
class _SubcatalogsListPageState extends State<SubcatalogsListPage>
    with AutomaticKeepAliveClientMixin {
  GlobalKey<PaginationViewState> subCatalogPaginationViewkey =
  ...
  void initState() {
    ...
    scrollController.addListener(() {
      if (scrollController.position.pixels ==
        ...
        catalogsBloc
            .add(CatalogstNextPageEvent(catalogUuid: widget.preCataloUuid));
      }
    });
  }
                              ...
                              Row(
                                children: [
                                  ...
                                  AssortmentFilterButton(
                                      subcatalogUuid: widget.preCataloUuid),
                                  SizedBox(
                                      width: widthRatio(
                                          size: 15, context: context)),
                                  InkWell(
                                    onTap: () async {
                                      ...
                                      AssortmentsModel _assortmentsModel =
                                          await AssortmentsProvider(
                                                  isRecommendations: null,
                                                  currentPage: 1,
                                                  barcodes: result.rawContent)
                                              .getAssortments();
                                    ...
                                    child: Container(
                                        ...
                                        height: heightRatio(
                                            size: 40, context: context),
                                        padding: EdgeInsets.all(widthRatio(
                                                            ...
                                                            Navigator.push(
                                                              ...
                                                              MaterialPageRoute(
                                                                builder:
                                                                  ...
                                                                  isSearchPage:
                                                                      false,
                                                                  tagsListFromCatalog: state
                                                                      .catalogsList[
                                                                          index]
                                                                      .assortmentsTagsInStore,
                                                                  preCataloName: state
                                                                      .catalogsList[
                                                                          index]
                                                                      .name,
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Text(
                                                                            ...
                                                                            style:
                                                                                appTextStyle(color: colorBlack04),
                                                                          ),
                                                                        ],
                                                                      ),
                                                                    ),
