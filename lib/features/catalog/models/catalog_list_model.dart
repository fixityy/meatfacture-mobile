...
class CatalogListModel {
  ...
  CatalogListModel({
    ...
    required this.name,
    required this.level,
    required this.assortmentsCount,
    this.image,
    required this.isFinalLevel,
    required this.assortmentsCountInStore,
  ...
  factory CatalogListModel.fromJson(Map<String, dynamic> json) {
    ...
    return CatalogListModel(
      uuid: json["uuid"],
      assortmentsTagsInStore: json["assortments_tags_in_store"] == null
          ? null
          : List<String>.from(json["assortments_tags_in_store"].map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "subcatalog": subcatalog != null
            ? List<dynamic>.from(subcatalog!.map((x) => x.toJson()))
            : null,
      };
}
