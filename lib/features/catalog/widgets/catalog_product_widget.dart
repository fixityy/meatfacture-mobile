                        ...
                        setState(
                          () {
                            ...
                            widget.assortmentsListModel.priceWithDiscount =
                                resulte[1];
                            widget.assortmentsListModel.currentPrice =
                                resulte[2];
                            widget.assortmentsListModel.discountTypeColor =
                                resulte[3];
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: widget.assortmentsListModel.images
                                          ?.isNotEmpty ==
                                      true
                                  ? Colors.transparent
                                  : newGrey2,
                            ...
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(
                                  heightRatio(size: 5, context: context)),
                              child: widget.assortmentsListModel.images
                                          ?.isNotEmpty ==
                                      true
                                  ? CachedNetworkImage(
                          ...
                          widget.assortmentsListModel.discountType ==
                                  "App\\Models\\PromoDiverseFoodClientDiscount"
                              ? Positioned(
                          ...
                          //Любимый продукт:
                          widget.assortmentsListModel.discountType ==
                                  "App\\Models\\ClientActivePromoFavoriteAssortment"
                              ? Positioned(
                                  ...
                                  child: InkWell(
                                    onTap: () {
                                      AppAlert.show(
                                        context: context,
                                        message:
                                            "Этот товар был отмечен как “Любимый продукт”",
                                        sec: 3,
                                      );
                                    },
                                    child: SvgPicture.asset(
                          ...
                          Positioned(
                            ...
                            child: InkWell(
                              onTap: () async {
                                if (await AssortmentFilterButton()
                                  ...
                                  if (widget.assortmentsListModel.isFavorite) {
                                    setState(() => widget.assortmentsListModel
                                        .isFavorite = false);
                                  } else {
                                    setState(() => widget.assortmentsListModel
                                        .isFavorite = true);
                              ...
                              child: SvgPicture.asset(
                                  (widget.assortmentsListModel.isFavorite !=
                                              null &&
                                          widget
                                              .assortmentsListModel.isFavorite)
                          ...
                          //- скидка %
                          if (widget.assortmentsListModel.priceWithDiscount !=
                                  null &&
                              widget.assortmentsListModel.currentPrice !=
                                  null &&
                              widget.assortmentsListModel.priceWithDiscount !=
                                          ...
                                          TextSpan(
                                            ...
                                            text: widget.assortmentsListModel.priceWithDiscount == null
                                                ? (double.parse(widget.assortmentsListModel.currentPrice!) % 1 == 0
                                                    ? (double.parse(widget.assortmentsListModel.currentPrice!) * widget.assortmentsListModel.quantityInClientCart!)
                                                        .toStringAsFixed(0)
                      ...
                      Row(
                        ...
                        children: [
                          // Квант:
                          widget.assortmentsListModel.assortmentUnitId ==
                                  "kilogram"
                              ? Text(
                      ...
                      if (widget.isFavoriteProdiuctPicking != null &&
                          widget.isFavoriteProdiuctPicking!)
                        InkWell(
                          onTap: () async {
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: widget.assortmentsListModel.isPromoFavorite
                                  ? colorBlack03
                                  : mainColor,
                              borderRadius: BorderRadius.circular(
                                  widthRatio(size: 7, context: context)),
                            ),
                            child: Text(
                              widget.assortmentsListModel.isPromoFavorite
                                  ? "selectedText".tr()
                                  : "toChooseText".tr(),
                              style: appTextStyle(
                                fontSize:
                        ...
                        widget.isFromFavCatalogsList
                            ? InkWell(
                                onTap: () async {
                                  if (!widget
                                      .assortmentsListModel.isPromoFavorite) {
                                    String _isSettedFavoriteProduct;
                                    Fluttertoast.showToast(msg: "Подождите...");
                                    FavoriteProductVariantUuidModel
                                        _favoriteProductVariantUuidModel =
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: widget.assortmentsListModel
                                                .discountTypeColor ==
                                            null
                                        ? newRedDark
                                        : Color(int.parse(
                                            "0xff${widget.assortmentsListModel.discountTypeColor}")),
                                    borderRadius: BorderRadius.circular(
                                            ...
                                            TextSpan(
                                              style: appHeadersTextStyle(
                                                  ...
                                                  fontSize: heightRatio(
                                                      size: 12,
                                                      context: context)),
                                              text: ((widget.assortmentsListModel.priceWithDiscount ?? double.parse(widget.assortmentsListModel.currentPrice!)) * (widget.assortmentsListModel.assortmentUnitId == "kilogram" ? (double.tryParse(widget.assortmentsListModel.weight.toString()) ?? 0) / 1000 : (widget.assortmentsListModel.weight == "0" ? 1 : int.parse(widget.assortmentsListModel.weight!)))) % 1 == 0
                                                  ? ((widget.assortmentsListModel.priceWithDiscount ?? double.parse(widget.assortmentsListModel.currentPrice!)) *
                                                  ...
                                                  : ((widget.assortmentsListModel.priceWithDiscount ?? double.parse(widget.assortmentsListModel.currentPrice!)) *
                                                          (widget.assortmentsListModel.assortmentUnitId ==
                                                              ...
                                                              : (widget.assortmentsListModel.weight == "0" ? 1 : int.parse(widget.assortmentsListModel.weight!))))
                                                      .toStringAsFixed(2),
                                            ),
                                            TextSpan(
                                              text: " ${"rubleSignText".tr()}",
                                              ...
                                              if (widget.assortmentsListModel
                                                ...
                                                if (await BasketProvider().updateProductInBasket(
                                                    productUuid: widget
                                                        .assortmentsListModel
                                                        .uuid,
                                                    quantity: widget.assortmentsListModel
                                                                .assortmentUnitId !=
                                                            "kilogram"
                                                        ? widget
                                                            .assortmentsListModel
                      ...
                      if (widget.assortmentsListModel.totalBonus != null &&
                          widget.assortmentsListModel.totalBonus != 0)
                        Expanded(
                          child: Container(
                            decoration: BoxDecoration(
                                color: whiteColor,
                            ...
                            child: Row(
                              children: [
                                ...
                                SizedBox(
                                    width:
                                        widthRatio(size: 3, context: context)),
                                Text(
                                  widget.assortmentsListModel.totalBonus!
                                      .toStringAsFixed(0),
                                  style: appTextStyle(
                                      fontSize: 10,
